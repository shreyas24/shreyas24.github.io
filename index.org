...
:CUSTOM_ID: distra
:END:
Our group is part of the Distributed Trust and Algorithms (DisTrA) Lab and the [[http://cystar.iitm.ac.in/][Center for Cybersecurity, Trust, and Reliability (CyStar)]] at IIT Madras.
** Current Members
1. Nithin Salevemula (PhD)
** Past Members
1. Nandini B (Intern 2025)
2. Anwesha Banerjee (Intern 2025)
@@html: <hr class="col-xs-12">@@
...
| <30>                                                       | <20>                           | <10>       | <10>    |
|------------------------------------------------------------+--------------------------------+------------+---------|
| Distributed MIS Algorithms for Rational Agents using Games | Nithin Salevemula, Shreyas Pai | SIROCCO    | [[[https://arxiv.org/abs/2511.16533][arxiv]]] |
|------------------------------------------------------------+--------------------------------+------------+---------|
** 2025
#+ATTR_HTML: :class table table-bordered table-hover table-condensed
|----------------------------------------------------------------------------------+----------------------------------------------------------------------------------+----------------------------------------+---------|
...
:CUSTOM_ID: teaching
:END:
I am teaching [[https://sites.google.com/cse.iitm.ac.in/randalgs2026/home][CS6170: Randomized Algorithms]] in the 2026 even semester.
** Past Courses
- IIT Madras
  - Jul-Nov 2025: [[https://sites.google.com/cse.iitm.ac.in/da2025/][CS6851: Distributed Algorithms]]
